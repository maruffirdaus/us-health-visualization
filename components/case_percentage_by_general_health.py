...
def plot_case_percentage_by_general_health(
    ...
    df_final = pd.DataFrame({"GeneralHealth": general_health_order})
    ...
    fig = px.pie(
        ...
        category_orders={"General Health": general_health_order},
        title=f"{CONDITION_LABELS[selected_condition]} Case Percentage by General Health",
        hole=0.4,
    )
